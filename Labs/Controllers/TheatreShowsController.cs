...
namespace Labs.Controllers
{
    public class TheatreShowsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ShowDate,Description,Place,ImageUrl")] TheatreShow theatreShow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,ShowDate,Description,Place,ImageUrl")] TheatreShow theatreShow)
        {
